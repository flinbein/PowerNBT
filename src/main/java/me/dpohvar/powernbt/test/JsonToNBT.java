...
{
    public static NBTBase parse(String p_150315_0_) throws NBTException
    {
    ...
    {
        protected ArrayList<Any> field_150492_b = new ArrayList();
        ...
        public NBTBase func_150489_a()
        {
            ...
            {
                JsonToNBT.Any any = (JsonToNBT.Any)iterator.next();
                nbttaglist.add(any.func_150489_a());
            }
