...
public class VersionFix {
    ...
    private static class FixHandler implements InvocationHandler{
        private Object o;
        public FixHandler(Object o){this.o=o;}
    ...
    public static Object callStaticMethod(String className, String methodName, Class[] classes, Object... params){
        try {
    ...
    public static <T> T getShell(Class<T> proxy, final Object object) {
        if (object!=null)try {
            return (T) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), new Class[]{proxy}, new FixHandler(object));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
